...
bot = telebot.TeleBot('8000254487:AAGIcn1Mp0gstyi2j-gcx4GdaFoHbPiEous')
...
def generate_key(duration):
    ...
    return f"@RAJPUTDDOS-{duration.upper()}-{random_part}"
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 @RAJPUTDDOS 𝗯𝗼𝘁!", reply_markup=markup)
